...
def process():
    ...
    url_string = 'https://data-live.flightradar24.com/zones/fcgi/feed.js?bounds=52.26,51.98,4.37,5.31&faa=1&mlat=1&flarm=1&adsb=1&gnd=0&air=1&vehicles=0&estimated=1&maxage=14400&gliders=0&stats=1'
...
def print_flight_info(flight_info):
    ...
    print 'Speed: {} knots, altitude: {} feet, heading: {} degrees'.format(last_trail['spd'], last_trail['alt'],last_trail['hd'])
